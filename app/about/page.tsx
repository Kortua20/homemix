...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "ჩვენ შესახებ | Home Mix",
    description: "გაიგეთ მეტი Home Mix-ის ავეჯის ონლაინ კატალოგის შესახებ.",
    url: "/about",
    images: [
      {
        url: "/hero/living-room.webp",
        alt: "Home Mix-ის თანამედროვე ინტერიერი",
      },
    ],
  },
};
  ...
  return (
    <main className="bg-[#f4f2ed]">
      <div className="mx-auto grid w-full max-w-7xl gap-10 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:gap-16 lg:px-8 lg:py-20">
        ...
        <div className="relative min-h-80 overflow-hidden rounded-2xl bg-[#e8ebe7] sm:min-h-107.5 lg:min-h-130">
          <Image

export default function ProductsLoading() {
  return (
    <main aria-live="polite" aria-busy="true" className="bg-[#fcf9f8]">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        ...
        <div className="mt-16 grid grid-cols-1 gap-5 min-[520px]:grid-cols-2 lg:grid-cols-4">
          {[0, 1, 2, 3].map((item) => (
            <div key={item} className="aspect-[4/3] animate-pulse rounded-2xl bg-[#e6e2de] motion-reduce:animate-none" />
          ))}
        </div>
      </div>
    </main>
